package com.exemplos.aula09_exemplo04_broadcastreceiver;
...
public class MainActivity  extends Activity {        
	...
	private BroadcastReceiver mBatInfoReceiver = new BroadcastReceiver() {        
		@Override          //When Event is published, onReceive method is called        
		public void onReceive(Context c, Intent i) {              //Get Battery %            
